...
def train(args, model, train_loader):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, trains in enumerate(train_loader):
            ...
            loss, loss_seq, loss_sim, correct_seq, correct_sim, denominator_seq = compute_loss(outputs_cls,
                                                                                               outputs_seq,
                                                                                               pt_batch)
            loss.backward()
            optimizer.step()
            ...
            if total_batch % args.save_steps == 0 and total_batch != 0:
                ...
                if total_loss / args.save_steps < best_loss:
                    best_loss = total_loss / args.save_steps
